...
namespace Api.Migrations
{
    ...
    [Migration("20260222124018_AddTrainerWorkoutTypes")]
    partial class AddTrainerWorkoutTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Data.AppUser", b =>
                {
                    ...
                    b.Property<bool>("PushClientLinkResponsesEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.Property<bool>("PushTrainerLinkRequestsEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("Api.Data.Booking", b =>
                {
                    ...
                    b.Property<DateTime?>("ClientConfirmationRequestedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("ClientConfirmationRespondedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("ClientConfirmationStatus")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.HasIndex("ClientId", "ClientConfirmationStatus");
            ...
            modelBuilder.Entity("Api.Data.TrainerClientLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("RejectedUntilUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("TrainerId", "ClientUserId")
                        .IsUnique();

                    b.ToTable("trainer_client_links", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Data.TrainerWorkoutType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TrainerId", "IsArchived");

                    b.HasIndex("TrainerId", "NormalizeKey")
                        .IsUnique();

                    b.ToTable("trainer_workout_types", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Data.Booking", b =>
                {
                    ...
                    b.HasOne("Api.Data.TrainerWorkoutType", "WorkoutType")
                        .WithMany()
            ...
            modelBuilder.Entity("Api.Data.TrainerClientLink", b =>
                {
                    b.HasOne("Api.Data.AppUser", "ClientUser")
                        .WithMany()
